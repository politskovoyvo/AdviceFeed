...
import { TUseCheckboxProps } from './models';
export declare function useCheckbox(props: TUseCheckboxProps): {
    state: {
        checked: boolean;
        disabled: boolean | undefined;
    };
    getInputProps: (forwardedRef?: ForwardedRef<HTMLInputElement>) => {
