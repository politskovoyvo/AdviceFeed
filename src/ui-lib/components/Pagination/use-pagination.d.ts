...
/// <reference types="react" />
import { ISelectOption, TOptionValue } from '../Select/models';
import { TPaginationStep, TUsePaginationProps, TUsePaginationSizeProps, TUsePaginationStepsProps } from './models';
export type TUsePaginationReturn = ReturnType<typeof usePagination>;
export declare function usePagination(props: TUsePaginationProps): {
    disabled: boolean;
    readOnly: boolean;
    totalSteps: number;
    total: number;
    sizeRef: import("react").MutableRefObject<number>;
    stepRef: import("react").MutableRefObject<number>;
    updateSteps: () => void;
    updateState: () => void;
    htmlProps: {
...
export declare function usePaginationSize(props: TUsePaginationSizeProps): {
    onChange: (value: TOptionValue) => void;
    disabled: boolean;
    size: number;
    readOnly: boolean;
    optionsList: ISelectOption<number, any>[];
    htmlProps: {
        hidden?: boolean | undefined;
        color?: string | undefined;
        content?: string | undefined;
...
export declare function usePaginationSteps(props: TUsePaginationStepsProps): {
    htmlProps: {
        hidden?: boolean | undefined;
        color?: string | undefined;
        content?: string | undefined;
    ...
    disabled: boolean;
    stepsView: TPaginationStep[];
    increase: () => void;
    decrease: () => void;
    chooseStep: (choice: TPaginationStep) => void;
};
