import { ChangeEvent, ClipboardEvent, KeyboardEventHandler, Ref } from 'react';
import { ICharInputFieldProps, TCharInputTypeMode, TUseCharInputProps } from './models';
export type TUseCharInputReturn = ReturnType<typeof useCharInput>;
export declare function useCharInput(props: TUseCharInputProps): {
    htmlProps: {
        ...
        autoFucus?: boolean | undefined;
    };
    getInputProps: (_props: ICharInputFieldProps & {
        index: number;
    ...
    descendants: import("../Descendants").DescendantsManager<HTMLInputElement, {}>;
    theme: import("../Input/models").TInputTheme | undefined;
    fieldSize: import("../Input/models").TInputSize | undefined;
};
export type TUseCharInputFieldReturn = ReturnType<typeof useCharInputField>;
export declare function useCharInputField(): {
    getInputProps: (_props: ICharInputFieldProps & {
        index: number;
    }, _ref: Ref<HTMLInputElement>) => {
        ref: Ref<HTMLInputElement>;
    ...
    index: number;
    theme: import("../Input/models").TInputTheme;
    fieldSize: import("../Input/models").TInputSize;
};
